    ...
    public class Geometry
    {
        ...
        public void LoadObject(string filename)
        {
            try
            {
                ...
                foreach (OpenGL_Game.Engine.OBJLoader.CjClutter.ObjLoader.Loader.Data.Elements.Group group in obj.Groups)
                {
                    ...
                    {
                        newGroup.texture = ResourceManager.LoadTexture("Engine\\Geometry\\Default\\default.png");
                    }
                    bool error = false;
                    string errorMessage = "";
                    ...
                    GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(newGroup.vertices.Count * 4), newGroup.vertices.ToArray<float>(), BufferUsageHint.StaticDraw);
                    ...
                    if (obj.Textures.Count > 0)
                    {
                        ...
                        GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(newGroup.textureCoords.Count * 4), newGroup.textureCoords.ToArray<float>(), BufferUsageHint.StaticDraw);
                    ...
                    if (obj.Normals.Count > 0)
                    {
                        ...
                        GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(newGroup.normals.Count * 4), newGroup.normals.ToArray<float>(), BufferUsageHint.StaticDraw);
