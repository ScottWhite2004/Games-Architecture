...
namespace OpenGL_Game.Engine.OBJLoader.CjClutter.ObjLoader.Loader.Data.DataStore
{
    ...
    {
        private OpenGL_Game.Engine.OBJLoader.CjClutter.ObjLoader.Loader.Data.Elements.Group _currentGroup;

        private readonly List<OpenGL_Game.Engine.OBJLoader.CjClutter.ObjLoader.Loader.Data.Elements.Group> _groups = new List<OpenGL_Game.Engine.OBJLoader.CjClutter.ObjLoader.Loader.Data.Elements.Group>();
        ...
        public IList<OpenGL_Game.Engine.OBJLoader.CjClutter.ObjLoader.Loader.Data.Elements.Group> Groups
        {
            get { return _groups; }
        }
        ...
        {
            _currentGroup = new Engine.OBJLoader.CjClutter.ObjLoader.Loader.Data.Elements.Group(groupName);
