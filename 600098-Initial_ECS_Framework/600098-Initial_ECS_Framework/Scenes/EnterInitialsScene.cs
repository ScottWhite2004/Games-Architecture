...
namespace OpenGL_Game.Scenes
{
    internal class EnterInitialsScene : Scene
    {
        ...
        public EnterInitialsScene(SceneManager sceneManager, Dictionary<string,int> pHighScores, int pScore, HighScoreManager pHighScoreManager) : base(sceneManager)
        {
            highScoreManager = pHighScoreManager;
            client = highScoreManager.client;
            score = pScore;
        ...
        public void Mouse_BottonPressed(MouseButtonEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButton.Left:
                    client.SendHighscore(intitials, score);
